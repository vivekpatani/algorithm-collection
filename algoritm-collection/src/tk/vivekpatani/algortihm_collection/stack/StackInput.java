...
public class StackInput {
	...
	/**
	 * Method to return the Input Data - Integers
	 * @return inputArray[]
	 */
	public ArrayList<Integer> stackInputInt(){
		
		ArrayList<Integer> inputData = new ArrayList<>();
		
		//Take the input from user here
		System.out.println(ConstantsStack.OPTIONS_STACK_TYPE[0]);
		System.out.println(ConstantsMain.OPTION_EXIT);
		do {
			input = ConstantsMain.scanner.next();
			inputData.add(Integer.parseInt(input));
	 ...
	 * @return 
	 */
	public ArrayList<String> stackInputString(){
