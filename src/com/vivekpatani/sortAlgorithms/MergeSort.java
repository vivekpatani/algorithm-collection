 ...
 */
package com.vivekpatani.sortAlgorithms;

import com.vivekpatani.commonconstants.Constants;

/**
 * Programme to implement Merger Sort Algorithm.
 * This code is based on the CLRS book and follows that pseudo code.
 */
public class MergeSort {
	...
	/**
	 * This is used to Merge the output from the leaves generated after splitting them into
	 * individual elements.
	 * @param data
	 * @param p
	 * @param q
