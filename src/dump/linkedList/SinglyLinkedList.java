...
public class SinglyLinkedList {
	...
	/**
	 * This is used to add a Node at the start of the LinkedList Boolean is to
	 * just make sure the addition went through (Debugging Purpose Only)
	 * 
	 * @return
	 */
	 ...
	 * eventually a value Boolean is to just make sure the addition went through
	...
	/**
	 * Checks whether if the LinkedList is empty or not The idea is to check
	 * whether if head is null or not
	 */
