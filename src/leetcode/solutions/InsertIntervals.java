...
import leetcode.solutions.MergeIntervals.Interval;
import leetcode.solutions.MergeIntervals.IntervalComparator;
...
public class InsertIntervals {
	...
	public static void main(String[] args) {
		...
		List<Interval> output = mergeBoundaries(input, new Interval(2,8));
		System.out.println();
	...
	public static List<Interval> mergeBoundaries(List<Interval> intervals, Interval newInterval) {
