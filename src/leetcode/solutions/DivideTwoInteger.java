...
<<<<<<< Updated upstream
	...
	public static int divide(int dividend, int divisor) {
		...
		// This is to ensure we do not cross the numerator, but ratio reaches about 1.
		...
		if (divisor_sign == -1 && dividend_sign == -1) return quotient;
		else if (divisor_sign == 1 && dividend_sign == 1) return quotient;
